...
export const Footer = () => {
  return <footer className="bg-foreground/[0.02] border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.company.map(link => <li key={link.label}>
                  {link.href.startsWith("/") ? <Link to={link.href} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                      {link.label}
                    </Link> : <a href={link.href} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                      {link.label}
                    </a>}
                </li>)}
            </ul>
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © 2026 MyCodex.Dev. All rights reserved.
          </p>
