  ...
  return (
    <div className="minimal-root">
      ...
      <header className="header">
        ...
        <button className="cta" onClick={() => alert("We'll get back to you soon.")}>
          Contact
        </button>
      </header>
      ...
      <footer className="content">
        <span className="tag">Designed for focus</span>
        <h2 className="heading">Composable. Accessible. Production-ready.</h2>
        <p className="desc">
