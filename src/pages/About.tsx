  ...
  return (
    ...
    >
      <div className="relative z-10">
        <div className="w-10 h-10 rounded-md bg-secondary border border-border flex items-center justify-center mb-5 group-hover:border-primary/20 transition-all duration-200">
          <IconComponent className="w-5 h-5 text-muted-foreground group-hover:text-primary transition-colors duration-200" strokeWidth={1.5} />
        </div>
        
        <h3 className="text-base font-semibold text-foreground mb-2 transition-colors duration-200">
          {feature.title}
        </h3>
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="relative z-10 pt-28 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="mb-10">
              <span className="inline-block text-xs font-medium tracking-widest text-muted-foreground uppercase mb-3">
                Capabilities
              </span>
          ...
          >
            ...
            <div className="space-y-6 mb-12">
              ...
              <motion.p 
                className="text-lg md:text-xl text-muted-foreground/90 leading-relaxed"
                initial={{ opacity: 0, y: 15 }}
                animate={{ opacity: 1, y: 0 }}
